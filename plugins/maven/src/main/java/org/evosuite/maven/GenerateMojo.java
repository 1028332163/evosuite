...
public class GenerateMojo extends AbstractMojo {
	...
	/**
	 * Comma ',' separated list of CUTs to use in CTG. If none specified, then test
	 * all classes
	 */
	...
	/**
	 * Absolute path to a file having the list of CUTs specified. This is needed for
	 * operating systems like Windows that have constraints on the size of input
	 * parameters and so could not use "cuts" parameter instead if too many CUTs are
	 * specified
	 */
	 ...
	 * separated list
	 */
	// FIXME would be nice to have the value of Properties.CRITERION but seems to be
	// not possible
	...
	/**
	 * Defines which of the included files in the source directories to exclude (non
	 * by default).
	 */
