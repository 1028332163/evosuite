...
//		org.evosuite.utils.LoggingUtils.getEvoLogger().info("lzw test:loadClass "+name);
...
//		org.evosuite.utils.LoggingUtils.getEvoLogger().info("lzw test:instrumentClass "+fullyQualifiedTargetClass);
		String className = fullyQualifiedTargetClass.replace('.', '/');
		InputStream is = null;
		try {
			is = isRegression ?
