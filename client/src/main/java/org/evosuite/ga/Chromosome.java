...
//			org.evosuite.utils.LoggingUtils.getEvoLogger().info("lzw one individual=================:");
			for (FitnessFunction<?> fitnessFunction : fitnessValues.keySet()) {
//				org.evosuite.utils.LoggingUtils.getEvoLogger().info("lzw one function:"+fitnessFunction.getClass().getName()+fitnessValues.get(fitnessFunction));
				sumFitnesses += fitnessValues.get(fitnessFunction);
			}
			return sumFitnesses;
		} else {
//			org.evosuite.utils.LoggingUtils.getEvoLogger().info("lzw one function:"+fitnessValues.keySet().iterator().next().getClass().getName()+fitnessValues.get(fitnessValues.keySet().iterator().next()));
