...
public class MonotonicGA<T extends Chromosome> extends GeneticAlgorithm<T> {
	...
	public MonotonicGA(ChromosomeFactory<T> factory) {
		super(factory);
		LoggingUtils.getEvoLogger().info("lzw algorithm:"+factory.getClass().getName());
...
//			org.evosuite.utils.LoggingUtils.getEvoLogger().info("Best individual has fitness: " + population.get(0).getFitness());
//			org.evosuite.utils.LoggingUtils.getEvoLogger().info("Worst individual has fitness: " + population.get(population.size() - 1).getFitness());
//			for(int i=0;i<population.size();i++) {
//				org.evosuite.utils.LoggingUtils.getEvoLogger().info("population fitness: " + population.get(i).getClass().getName());
//				org.evosuite.utils.LoggingUtils.getEvoLogger().info("population fitness: " + population.get(i).getFitness());
//			}
