...
//				org.evosuite.utils.LoggingUtils.getEvoLogger().info("lzw test:"+observer.getClass().getName());
...
//			org.evosuite.utils.LoggingUtils.getEvoLogger().info("-----lzw test:"+s.toString()+" type:"+s.getClass().getName());
